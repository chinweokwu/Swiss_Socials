...
const Profile = () => {
  ...
  return (
    <div className="profile p-8 ">
        <div className="setting relative rounded-lg shadow-xl pb-8">
            <div className="w-full h-[250px] personal-info">
                <img alt='' src="https://vojislavd.com/ta-template-demo/assets/img/profile-background.jpg" className="w-full h-full rounded-tl-lg rounded-tr-lg"/>
            </div>
            <div className="flex flex-col items-center -mt-20">
                <img alt='' src="https://vojislavd.com/ta-template-demo/assets/img/profile.jpg" className="w-40 border-4 border-white rounded-full"/>
                ...
                <p className="">Senior Software Engineer at Tailwind CSS</p>
        ...
        <div className="my-4">
            <div className="w-full flex flex-col">
                <div className="flex-1 personal-info rounded-lg shadow-xl p-8">
