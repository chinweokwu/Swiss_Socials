...
const Profile = () => {
  ...
  return (
    <div class="profile p-8 ">
        <div class="setting relative rounded-lg shadow-xl pb-8">
            <div class="absolute left-10 mt-4 rounded">
                <button onClick={()=> setOpen(!open)} class="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
                    </svg>
                </button>
            {open && <div class="bg-white absolute w-40 py-2 mt-1 border border-gray-200 shadow-2xl">
                    <div class="py-2">
            ...
            <div class="w-full h-[250px] personal-info">
            ...
            <div class="flex flex-col items-center -mt-20">
                ...
                <p class="">Senior Software Engineer at Tailwind CSS</p>
        ...
        <div class="my-4">
            <div class="w-full flex flex-col">
                <div class="flex-1 personal-info rounded-lg shadow-xl p-8">
