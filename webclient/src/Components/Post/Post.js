...
const Post = ({post}) => {
  ...
  return (
    <div className='post'>
        <article class="mb-4 break-inside p-6 rounded-xl flex flex-col bg-clip-border">
        <div class="flex pb-6 items-center justify-between">
          <div class="flex">
            <a class="inline-block mr-4" href="#">
              <img class="rounded-full max-w-none w-14 h-14" src={post.profilePic} />
            </a>
            <div class="flex flex-col">
              <div class="flex items-center">
                <a class="inline-block text-lg font-bold mr-2" href="#">{post.name}</a>
                <span>
        ...
        <div class="py-4">
          <div class="inline-flex items-center" href="#">
            ...
            <button 
              ...
              type="button" 
              class="relative  mx-5 inline-flex items-center p-1 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
